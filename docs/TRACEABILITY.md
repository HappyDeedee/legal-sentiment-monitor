...
| CR-007 | Account environment and profile migration direction | Phase 5, Phase 6 | api/monitoring/account_environment.py, api/monitoring/database.py, api/monitoring/runner.py, api/routers/monitor.py, docs/ACCOUNT_ENVIRONMENT.md, docs/DATA_MODEL.md | tests/test_monitoring_mvp.py::test_phase_5_social_account_profile_key_drives_runtime_path, tests/test_monitoring_mvp.py::test_runner_injects_active_account_profile_for_cdp, tests/test_monitoring_mvp.py::test_login_session_uses_social_account_profile | Verified for Phase 5 account environment; Phase 6 login-state flow remains |
...
| CR-012A | Account environment profile key format | Phase 5, Phase 6 | api/monitoring/account_environment.py, api/monitoring/database.py, api/monitoring/runner.py, docs/ACCOUNT_ENVIRONMENT.md, docs/SCHEMA_MIGRATION.md | tests/test_monitoring_mvp.py::test_phase_5_social_account_profile_key_drives_runtime_path, tests/test_monitoring_mvp.py::test_phase_5_profile_key_resolver_rejects_path_traversal | Verified for Phase 5 resolver; Phase 6 profile persistence flow remains |
