...
| CR-012A | Account environment profile key format | Phase 5, Phase 6 | docs/ACCOUNT_ENVIRONMENT.md, docs/SCHEMA_MIGRATION.md | Profile resolver tests | Needs Confirmation |
| CR-012B | Account and profile lock timeout | Phase 5, Phase 6 | docs/ACCOUNT_ENVIRONMENT.md, docs/SCHEMA_MIGRATION.md, docs/SYSTEM_SETTINGS.md | Stale-lock recovery tests | Needs Confirmation |
| CR-012C | Account/profile/proxy lock storage | Phase 5, Phase 6 | docs/ACCOUNT_ENVIRONMENT.md, docs/SCHEMA_MIGRATION.md | Account/profile/proxy lock tests | Needs Confirmation |
